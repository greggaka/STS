    	...
    	<div class='container'>
	    	...
	    	<div class='bg-light border border-dark rounded w-50 mx-auto' >
		    	<div class="text-center my-3">
					<h2>Assign Class Instructor for <br /> ${ classs.name }</h2>
	    		</div>
				<form:form action = "/classes/add-instructor/${ classs.id }" modelAttribute="classs" method="post" class="container">
		    		...
		    		<div class="form-group">
			            ...
			            <form:select path="instructor" class='form-control'>
			            	<c:forEach items="${ allFaculty }" var="faculty">
			            		<c:if test="${ classs.period.id == faculty.organization.id }">
