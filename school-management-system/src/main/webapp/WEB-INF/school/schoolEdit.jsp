    ...
    <body id='background'>
    	<div class='container'>
	    	...
	    	<div class='bg-light border border-dark rounded w-50 mx-auto' >
				...
				<form:form action = "/schools/edit/${ school.id }" modelAttribute="school" method="post" class="container">
	    	...
	    	<div class='bg-light mt-5 border border-dark rounded w-75 mx-auto mb-5'>
	    		...
	    		<table class="container table table-hover align-middle bg-white border border-2 rounded">
				    ...
				    <tbody>
				        ...
				        <tr>
				            <td>
				            	<a href="/schools/${school.id}" class="text-decoration-none link-dark"><c:out value="${school.id }" /></a>
				            </td>		
				            <td>
				            	<a href="/schools/${school.id}" class="text-decoration-none link-dark"><c:out value="${school.name }" /></a>
				            </td>
				            <td>
				            	<a href="/schools/${school.id}" class="text-decoration-none link-dark"><c:out value="${school.type }" /></a>
				            </td>
				            <td>
				            	<a href="/schools/${school.id}" class="text-decoration-none btn btn-success">View</a>
				            </td>
				        </tr>
				        </c:forEach>
				    </tbody>
